...
ONLINE_INTERACTION_PSEUDO_HISTORY_SCALE="${ONLINE_INTERACTION_PSEUDO_HISTORY_SCALE:-0.0}"
ONLINE_FIRST_FRAME_MEMORY_SLOTS="${ONLINE_FIRST_FRAME_MEMORY_SLOTS:-1}"
ONLINE_PRIMARY_FIRE_CLICK_RADIUS_FRAMES="${ONLINE_PRIMARY_FIRE_CLICK_RADIUS_FRAMES:-12}"
ONLINE_PRIMARY_FIRE_RESIDUAL_THRESHOLD="${ONLINE_PRIMARY_FIRE_RESIDUAL_THRESHOLD:-0.08}"
ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE="${ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE:-3.0}"
...
echo "[train] fire_click_radius=${ONLINE_PRIMARY_FIRE_CLICK_RADIUS_FRAMES} fire_residual_threshold=${ONLINE_PRIMARY_FIRE_RESIDUAL_THRESHOLD} fire_focus_loss_scale=${PRIMARY_FIRE_FOCUS_LOSS_SCALE:-${ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE}} fire_background_loss_scale=${PRIMARY_FIRE_BACKGROUND_LOSS_SCALE:-${ONLINE_PRIMARY_FIRE_BACKGROUND_LOSS_SCALE}}"
...
CMD=(
  ...
  --online_primary_fire_click_radius_frames "${ONLINE_PRIMARY_FIRE_CLICK_RADIUS_FRAMES}"
  --online_primary_fire_residual_threshold "${ONLINE_PRIMARY_FIRE_RESIDUAL_THRESHOLD}"
  --primary_fire_focus_loss_scale "${PRIMARY_FIRE_FOCUS_LOSS_SCALE:-${ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE}}"
  --primary_fire_background_loss_scale "${PRIMARY_FIRE_BACKGROUND_LOSS_SCALE:-${ONLINE_PRIMARY_FIRE_BACKGROUND_LOSS_SCALE}}"
