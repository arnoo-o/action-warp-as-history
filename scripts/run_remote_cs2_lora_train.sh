...
echo "[train] first_frame_memory_slots=${ONLINE_FIRST_FRAME_MEMORY_SLOTS} fire_click_radius=${ONLINE_PRIMARY_FIRE_CLICK_RADIUS_FRAMES} fire_residual_threshold=${ONLINE_PRIMARY_FIRE_RESIDUAL_THRESHOLD} fire_focus_loss_scale=${ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE}"
...
CMD=(
  ...
  --online_first_frame_memory_slots "${ONLINE_FIRST_FRAME_MEMORY_SLOTS}"
