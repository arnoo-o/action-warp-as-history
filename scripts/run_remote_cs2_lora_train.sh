...
echo "[train] fire_click_radius=${ONLINE_PRIMARY_FIRE_CLICK_RADIUS_FRAMES} fire_residual_threshold=${ONLINE_PRIMARY_FIRE_RESIDUAL_THRESHOLD} fire_focus_loss_scale=${ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE} fire_background_loss_scale=${ONLINE_PRIMARY_FIRE_BACKGROUND_LOSS_SCALE}"
...
CMD=(
  ...
  --online_primary_fire_focus_loss_scale "${ONLINE_PRIMARY_FIRE_FOCUS_LOSS_SCALE}"
  --online_primary_fire_background_loss_scale "${ONLINE_PRIMARY_FIRE_BACKGROUND_LOSS_SCALE}"
